...
class paginate
{
		...
		if($rowCount>0)
		{
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
				...
				<div class="news flex-center">
					       		...
					       		<div class="date-more">
					       			<div class="date"><?php print $row['time'];?></div>
					       			
                                     <div class="date1"><a href="<?php print $site_url; ?>read/<?php print $row['id']; ?>">Read more</a></div>
	...
	{		
		...
		{
			?><center><ul class="pagination pagination-sm" style="border-radius:10px;"><li><?php
			...
			for($i=$x;$i<=$x+3;$i++)
			{
				if($i==$current_page)
				{
					echo "<a class='current' href='".$self.$i."' style='color:white;background-color:#225f0e;text-decoration:none'>".$i."</a>&nbsp;&nbsp;";
				}
